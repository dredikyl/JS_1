...
var myRandom = Math.round(Math.random()*10)// случайное число между 0..10 → myRandom
 ...
 */
console.log("strReplace toUpperCase : ", strReplace.toUpperCase());
console.log("strReplace toLowerCase : ", strReplace.toLowerCase());